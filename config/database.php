...
return [
    ...
    */
    ...
    'redis' => [
        ...
        'default' => [
            'host'     => config('config_'.$environment.'.REDIS_HOST'),
            'password' => config('config_'.$environment.'.REDIS_PASSWORD'),
            'port'     => config('config_'.$environment.'.REDIS_PORT'),
            'database' => config('config_'.$environment.'.REDIS_DATABASE'),
        ],
